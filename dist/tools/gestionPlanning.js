...
exports.prepareIcalForDB = exports.getIcalFromWeb = void 0;
const ical_1 = __importDefault(require("ical"));
/*
* fetch du ical et le parse
*/
const getIcalFromWeb = (icalURL) => __awaiter(void 0, void 0, void 0, function* () {
    const reponse = yield fetch(icalURL);
    const vcalendar = yield reponse.text();
    const parsed = ical_1.default.parseICS(vcalendar);
    return parsed;
});
